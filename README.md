...
## 🌍 Acceso Online (Para el Equipo)

La aplicación está desplegada en la nube. El equipo puede acceder directamente a través del enlace de Streamlit Community Cloud (compartir URL generada).

Repositorio de código: [https://github.com/alejerez92/procesador-vouchers](https://github.com/alejerez92/procesador-vouchers)
...
*   **Contrato "FIJO POR SERVICIO":**
    *   **Regla Base:** El `$ Total` siempre debe ser mayor al `$ Costo proveedor`.
    *   **Margen Mínimo (10%):** Se exige un margen superior al 10% sobre el costo.
        *   *Excepción:* No se exige el 10% si la ciudad es: *Punta Cana, Lima, Santo Domingo, Buenos Aires, Río de Janeiro, Bogotá, Mendoza* o *Medellin*.

*   **Excepción Variable (Booking / I Need Tours):**
    *   Aplica solo para convenios "BOOKING" o "I NEED TOURS" con contratos "VARIABLE 23 A 30% ADMIN" o "VARIABLE 25 A 31% ADMIN".
    *   **Permite pérdida controlada:** El Costo puede ser mayor al Total, siempre que la diferencia (pérdida) **no supere los $5.000**.
